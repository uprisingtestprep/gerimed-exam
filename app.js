/* GERIMED Exam Simulator, Application Logic */

const ACCESS_CODE  = "GERIMED9000";
const EXAM_SECONDS = 29988;
const PASSING_PCT  = 72;
const STORAGE_KEY  = "gerimed_exam_state_v1";
...
const DOMAIN_LABELS = {"diseases_in_the_elderly": "Diseases in the Elderly", "geriatric_syndromes": "Geriatric Syndromes", "caring_for_elderly_patients": "Caring for Elderly Patients", "geriatric_psychiatry": "Geriatric Psychiatry", "gerontology": "Gerontology", "functional_assessment_and_rehabilitation": "Functional Assessment and Rehabilitation"};  // maps domain key -> human-readable label for display
